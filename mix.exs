  ...
  defp docs do
    [
      ...
      groups_for_modules: [
        ...
        Context: [
          Fact.Context,
          Fact.IndexCheckpointFileDecoder,
          Fact.IndexCheckpointFileEncoder,
          Fact.IndexCheckpointFileName,
          Fact.IndexCheckpointFileReader,
          Fact.IndexCheckpointFileWriter,
          Fact.IndexFileDecoder,
          Fact.IndexFileEncoder,
          Fact.IndexFileName,
          Fact.IndexFileReader,
          Fact.IndexFileWriter,
          Fact.LedgerFileDecoder,
          Fact.LedgerFileEncoder,
          Fact.LedgerFileName,
          Fact.LedgerFileReader,
          Fact.LedgerFileWriter,
          Fact.RecordFileDecoder,
          Fact.RecordFileEncoder,
          Fact.RecordFileName,
          Fact.RecordFileReader,
