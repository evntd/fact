defmodule Fact.EventQueryWriter do
  ...
  def append(events, event_query, opts \\ []) do
    ...
    Logger.debug("EventQueryWriter call_ops: #{inspect(call_opts)}, append_opts: #{inspect(append_opts)}")
    ...
    Fact.EventLedger.commit(events, Keyword.put(call_opts, :condition, {event_query, expected_pos}))
  end
end
