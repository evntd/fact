defmodule Fact do
  ...
  * domain events are a first-class modeling tool
  ...
  ## Options
    ...
    * `:indexers` - A list of custom indexer specifications to start with the database.
      See `t:Fact.DatabaseSupervisor.indexer_spec/0`. Each entry is a module or `{module, opts}` tuple.
  ...
  ## Examples
    ...
    Opens a database with custom indexers.
